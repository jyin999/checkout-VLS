...
epicsEnvSet("IOCNAME", "ioc-VLSVacuum" )
epicsEnvSet("ENGINEER", "jyin" )
epicsEnvSet("LOCATION", "PLC:VLSVacuum" )
...
dbLoadRecords("iocSoft.db", "IOC=PLC:VLSVacuum")
dbLoadRecords("save_restoreStatus.db", "P=PLC:VLSVacuum:")
...
save_restoreSet_status_prefix( "PLC:VLSVacuum:" )
