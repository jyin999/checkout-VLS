...
epicsEnvSet("IOCNAME", "ioc-plc-tmo-hutch-vac-fs" )
epicsEnvSet("ENGINEER", "root" )
epicsEnvSet("LOCATION", "PLC:plc_tmo_hutch_vac_fs" )
...
epicsEnvSet("IPADDR",           "172.21.132.45")
epicsEnvSet("AMSID",            "172.21.132.45.1.1")
...
dbLoadRecords("iocSoft.db", "IOC=PLC:plc_tmo_hutch_vac_fs")
dbLoadRecords("save_restoreStatus.db", "P=PLC:plc_tmo_hutch_vac_fs:")
...
save_restoreSet_status_prefix( "PLC:plc_tmo_hutch_vac_fs:" )
