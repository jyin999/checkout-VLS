...
epicsEnvSet("IOCNAME", "ioc-plc-tmo-hutch-vac" )
epicsEnvSet("ENGINEER", "nwbrown" )
epicsEnvSet("LOCATION", "PLC:plc_tmo_hutch_vac" )
...
dbLoadRecords("iocSoft.db", "IOC=PLC:plc_tmo_hutch_vac")
dbLoadRecords("save_restoreStatus.db", "P=PLC:plc_tmo_hutch_vac:")
...
save_restoreSet_status_prefix( "PLC:plc_tmo_hutch_vac:" )
